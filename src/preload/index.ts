...
const neko: NekoApi = {
  ...
  getAutoLaunchOnboardingSeen: () => ipcRenderer.invoke(IpcChannel.AutoLaunchOnboardingSeenGet),
  dismissAutoLaunchOnboarding: () => ipcRenderer.invoke(IpcChannel.AutoLaunchOnboardingDismiss),
